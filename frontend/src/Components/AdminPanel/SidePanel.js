        ...
        <Styled.Wrapper>
            <Styled.SubWrapper>
                ...
                <Styled.Section>
                    ...
                    <Styled.Button onClick = {()=> navigate("/admin/usersPerWeek")}>Attendency Per Week</Styled.Button>
                    <Styled.Button onClick = {()=> navigate("/admin/usersPerClass")}>Attendency Per Class</Styled.Button>
                </Styled.Section>
            </Styled.SubWrapper>
        </Styled.Wrapper>
    );
